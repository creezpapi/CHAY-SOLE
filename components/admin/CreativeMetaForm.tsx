...
<div>
<label className="block text-sm font-medium mb-1.5" htmlFor="post_date">Post Date</label>
<input id="post_date" name="post_date" type="date" defaultValue={creative.post_date || ''}
...
<p className="text-xs text-rv-tab-inactive mt-1">Scheduled date this creative will be posted. Appears on the Posting Calendar.</p>
</div>
<div>
...
<div>
<label className="block text-sm font-medium mb-2">Drop Tag</label>
